...
// Mock HTML
const toggleButtonHtml = '<button class="dfe-header__menu-toggle" id="toggle-menu" aria-controls="header-navigation" aria-expanded="false">Menu</button>';
const closeButtonHtml = '<button class="dfe-header__navigation-close" id="close-menu"><span class="dfe-u-visually-hidden">Close menu</span></button>';
const navHtml = '<nav class="dfe-header__navigation" id="header-navigation" role="navigation" aria-label="Primary navigation" aria-labelledby="label-navigation"></nav>';
...
const initTest = (html) => {
  ...
  toggleButton = document.querySelector('.dfe-header__menu-toggle');
  closeButton = document.querySelector('.dfe-header__navigation-close');
  nav = document.querySelector('.dfe-header__navigation');
  MenuToggle();
};

describe('DfE menuToggle()', () => {
